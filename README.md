...
| 平台 | 登录方式 | 说明 |
|------|---------|------|
| iGPSPORT | 账号密码 | 官方开放API，直接登录 |
| 行者 | 账号密码 | 官方开放API，直接登录 |
| 迈金 | 账号密码 | 顽鹿账号登录 |
| 黑鸟单车 | 账号密码 | 官方API登录 |
| 百锐腾 | 账号密码 | localStorage方式登录 |
| Outbase | 手机号验证码 | 手机号获取验证码登录，俱乐部链接用于上传配置 |
| 佳明国际 | 账号密码 | 弹出对话框输入，mobile SSO自动登录 |
| 佳明中国 | 账号密码 | 弹出对话框输入，mobile SSO自动登录（参考garth库） |
| 高驰中国 | 账号密码 | 官方API登录 |
| 高驰国际 | 账号密码 | 官方API登录 |
| Wahoo | 账号密码 | 弹出对话框输入，后台自动完成SAML+OAuth2授权 |
